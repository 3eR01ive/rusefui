...
/** Синхронизация порта/подписи: при переходе в connected ИЛИ при первом mount если уже connected. */
watch(ready, (isReady) => {
  if (isReady && dataCtx.connection.value.connected) {
